...
<div class="container h-auto">
    <div class="container h-100 overflow-auto mb-5">
        {{$text}}
    </div>
    @if($errors->any())
    ...
    @if(Auth::check())
        @if(Auth::user()->isBlocked == 0)
            <div class="form-group my-5">
                ...
                @csrf
                    <input class="form-control w-75 h-auto" type="textarea" name="claim" placeholder="Жалобы и предложения к этому руководству оставьте здесь)"/><br/>
