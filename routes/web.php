...
Auth::routes();
Route::get('/manual_list', [App\Http\Controllers\ManualController::class, 'index'])->name('manual_list');
...
Route::get('/home', [App\Http\Controllers\ManualController::class, 'index'])->name('home');
Route::get('/download/{filename}', [App\Http\Controllers\ManualController::class, 'downloadManual'])->name('download');
Route::get('/read/{filename}', [App\Http\Controllers\ManualController::class, 'readManual'])->name('read');
Route::get('/manual_complaints/{filename}', [App\Http\Controllers\ManualController::class, 'manualComplaints'])->name('manual_complaints');
